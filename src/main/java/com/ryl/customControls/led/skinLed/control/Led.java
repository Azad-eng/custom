...
package com.ryl.customControls.led.skinLed.control;

import com.ryl.customControls.led.skinLed.skin.LedSkin;
...
public class Led extends Control {
    ...
    public static final LedType      DEFAULT_LED_TYPE    = LedType.SQUARE;
    ...
    public String getUserAgentStylesheet() {
        return getClass().getResource("/led/led.css").toExternalForm();
    }

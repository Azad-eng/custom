...
package com.ryl.customControls.clock.imgsplitflapClock;
...
public class SplitFlap extends Region {
    ...
    public static final  String[] EXTENDED       = {" ", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0",
        ...
        "W", "X", "Y", "Z", "-", "/", ":", ",", "", ";", "@",
        "#", "+", "?", "!", "%", "$", "=", "<", ">"};
    private static final Image    BACKGROUND     = new Image(SplitFlap.class.getResource("/clock/imgsplitflap/background.png").toExternalForm());
    private static final Image    FLAP           = new Image(SplitFlap.class.getResource("/clock/imgsplitflap/flap.png").toExternalForm());

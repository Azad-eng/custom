...
package com.ryl.customControls.other.heatcontrol;

import com.sun.javafx.css.converters.PaintConverter;
import com.ryl.customControls.other.heatcontrol.skin.HeatControlSkin;
...
public class HeatControl extends Control {
    ...
    public String getUserAgentStylesheet() {
        return getClass().getResource("/other/heatcontrol.css").toExternalForm();
    }

...
package com.ryl.customControls.other.signaltower;

import com.ryl.customControls.other.signaltower.skin.SignalTowerSkin;
...
public class SignalTower extends Control {
    ...
    public String getUserAgentStylesheet() {
        return getClass().getResource("/other/signaltower.css").toExternalForm();
    }
}

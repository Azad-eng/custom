...
package com.ryl.customControls.segment.sixteensegment;

import com.ryl.customControls.segment.sixteensegment.skin.SixteenSegmentSkin;
...
public class SixteenSegment extends Control {
    ...
    public String getUserAgentStylesheet() {
        return getClass().getResource("/segment/" + getClass().getSimpleName().toLowerCase() + ".css").toExternalForm();
    }
}

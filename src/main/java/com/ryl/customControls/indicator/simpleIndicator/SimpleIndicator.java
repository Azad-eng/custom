...
package com.ryl.customControls.indicator.simpleIndicator;

import com.ryl.customControls.indicator.simpleIndicator.skin.SimpleIndicatorSkin;
...
public class SimpleIndicator extends Control {
    ...
    public String getUserAgentStylesheet() {
        return getClass().getResource("/indicator/simpleIndicator.css").toExternalForm();
    }
}

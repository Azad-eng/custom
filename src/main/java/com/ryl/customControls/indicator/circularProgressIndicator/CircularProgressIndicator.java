package com.ryl.customControls.indicator.circularProgressIndicator;
...
public class CircularProgressIndicator extends Region {
    ...
    public CircularProgressIndicator() {
        getStylesheets().add(CircularProgressIndicator.class.getResource("/circularProgressIndicator/indicator.css").toExternalForm());

...
package com.ryl.customControls.gauge.radialBarGauge;

import com.sun.javafx.css.converters.PaintConverter;
import com.ryl.common.Marker;
import com.ryl.common.Section;
import com.ryl.customControls.gauge.radialBarGauge.skin.RadialBarGaugeSkin;
 ...
 * Time: 08:01
 */
public class RadialBarGauge extends Control {
    ...
    public final ObjectProperty<Paint> tickMarkFillProperty() {
        if (null == tickMarkFill) {
            tickMarkFill = new StyleableObjectProperty<Paint>(Color.BLACK) {
                ...
                @Override public Object getBean() { return RadialBarGauge.this; }
    ...
    public final boolean isInteractive() {
        return null != interactive && interactive.get();
    }
    ...
    @Override protected Skin createDefaultSkin() {
        return new RadialBarGaugeSkin(this);
    }

    @Override
    public String getUserAgentStylesheet() {
        return getClass().getResource("/gauge/radialBarGauge/radial-bargraph.css").toExternalForm();
    }

    private static class StyleableProperties {
        private static final CssMetaData<RadialBarGauge, Paint> TICK_MARK_FILL =
            new CssMetaData<RadialBarGauge, Paint>("-tick-mark-fill", PaintConverter.getInstance(), Color.BLACK) {

                @Override public boolean isSettable(RadialBarGauge radialBarGauge) {
                    return null == radialBarGauge.tickMarkFill || !radialBarGauge.tickMarkFill.isBound();
                }

                @Override public StyleableProperty<Paint> getStyleableProperty(RadialBarGauge radialBarGauge) {
                    return (StyleableProperty) radialBarGauge.tickMarkFillProperty();
                }
            };

        private static final CssMetaData<RadialBarGauge, Paint> SECTION_FILL_0 =
            new CssMetaData<RadialBarGauge, Paint>("-section-fill-0", PaintConverter.getInstance(), DEFAULT_SECTION_FILL_0) {

                @Override public boolean isSettable(RadialBarGauge radialBarGauge) {
                    return null == radialBarGauge.sectionFill0 || !radialBarGauge.sectionFill0.isBound();
                }

                @Override public StyleableProperty<Paint> getStyleableProperty(RadialBarGauge radialBarGauge) {
                    return (StyleableProperty) radialBarGauge.sectionFill0Property();
                }

                @Override public Paint getInitialValue(RadialBarGauge radialBarGauge) {
                    return radialBarGauge.getSectionFill0();
                }
            };

        private static final CssMetaData<RadialBarGauge, Paint> SECTION_FILL_1 =
            new CssMetaData<RadialBarGauge, Paint>("-section-fill-1", PaintConverter.getInstance(), DEFAULT_SECTION_FILL_1) {

                @Override public boolean isSettable(RadialBarGauge radialBarGauge) {
                    return null == radialBarGauge.sectionFill1 || !radialBarGauge.sectionFill1.isBound();
                }

                @Override public StyleableProperty<Paint> getStyleableProperty(RadialBarGauge radialBarGauge) {
                    return (StyleableProperty) radialBarGauge.sectionFill1Property();
                }

                @Override public Paint getInitialValue(RadialBarGauge radialBarGauge) {
                    return radialBarGauge.getSectionFill1();
                }
            };

        private static final CssMetaData<RadialBarGauge, Paint> SECTION_FILL_2 =
            new CssMetaData<RadialBarGauge, Paint>("-section-fill-2", PaintConverter.getInstance(), DEFAULT_SECTION_FILL_2) {

                @Override public boolean isSettable(RadialBarGauge radialBarGauge) {
                    return null == radialBarGauge.sectionFill2 || !radialBarGauge.sectionFill2.isBound();
                }

                @Override public StyleableProperty<Paint> getStyleableProperty(RadialBarGauge radialBarGauge) {
                    return (StyleableProperty) radialBarGauge.sectionFill2Property();
                }

                @Override public Paint getInitialValue(RadialBarGauge radialBarGauge) {
                    return radialBarGauge.getSectionFill2();
                }
            };

        private static final CssMetaData<RadialBarGauge, Paint> SECTION_FILL_3 =
            new CssMetaData<RadialBarGauge, Paint>("-section-fill-3", PaintConverter.getInstance(), DEFAULT_SECTION_FILL_3) {

                @Override public boolean isSettable(RadialBarGauge radialBarGauge) {
                    return null == radialBarGauge.sectionFill3 || !radialBarGauge.sectionFill3.isBound();
                }

                @Override public StyleableProperty<Paint> getStyleableProperty(RadialBarGauge radialBarGauge) {
                    return (StyleableProperty) radialBarGauge.sectionFill3Property();
                }

                @Override public Paint getInitialValue(RadialBarGauge radialBarGauge) {
                    return radialBarGauge.getSectionFill3();
                }
            };

        private static final CssMetaData<RadialBarGauge, Paint> SECTION_FILL_4 =
            new CssMetaData<RadialBarGauge, Paint>("-section-fill-4", PaintConverter.getInstance(), DEFAULT_SECTION_FILL_4) {

                @Override public boolean isSettable(RadialBarGauge radialBarGauge) {
                    return null == radialBarGauge.sectionFill4 || !radialBarGauge.sectionFill4.isBound();
                }

                @Override public StyleableProperty<Paint> getStyleableProperty(RadialBarGauge radialBarGauge) {
                    return (StyleableProperty) radialBarGauge.sectionFill4Property();
                }

                @Override public Paint getInitialValue(RadialBarGauge radialBarGauge) {
                    return radialBarGauge.getSectionFill4();
                }
            };

        private static final CssMetaData<RadialBarGauge, Paint> SECTION_FILL_5 =
            new CssMetaData<RadialBarGauge, Paint>("-section-fill-5", PaintConverter.getInstance(), DEFAULT_SECTION_FILL_5) {

                @Override public boolean isSettable(RadialBarGauge radialBarGauge) {
                    return null == radialBarGauge.sectionFill5 || !radialBarGauge.sectionFill5.isBound();
                }

                @Override public StyleableProperty<Paint> getStyleableProperty(RadialBarGauge radialBarGauge) {
                    return (StyleableProperty) radialBarGauge.sectionFill5Property();
                }

                @Override public Paint getInitialValue(RadialBarGauge radialBarGauge) {
                    return radialBarGauge.getSectionFill5();
                }
            };

        private static final CssMetaData<RadialBarGauge, Paint> SECTION_FILL_6 =
            new CssMetaData<RadialBarGauge, Paint>("-section-fill-6", PaintConverter.getInstance(), DEFAULT_SECTION_FILL_6) {

                @Override public boolean isSettable(RadialBarGauge radialBarGauge) {
                    return null == radialBarGauge.sectionFill6 || !radialBarGauge.sectionFill6.isBound();
                }

                @Override public StyleableProperty<Paint> getStyleableProperty(RadialBarGauge radialBarGauge) {
                    return (StyleableProperty) radialBarGauge.sectionFill6Property();
                }

                @Override public Paint getInitialValue(RadialBarGauge radialBarGauge) {
                    return radialBarGauge.getSectionFill6();
                }
            };

        private static final CssMetaData<RadialBarGauge, Paint> SECTION_FILL_7 =
            new CssMetaData<RadialBarGauge, Paint>("-section-fill-7", PaintConverter.getInstance(), DEFAULT_SECTION_FILL_7) {

                @Override public boolean isSettable(RadialBarGauge radialBarGauge) {
                    return null == radialBarGauge.sectionFill7 || !radialBarGauge.sectionFill7.isBound();
                }

                @Override public StyleableProperty<Paint> getStyleableProperty(RadialBarGauge radialBarGauge) {
                    return (StyleableProperty) radialBarGauge.sectionFill7Property();
                }

                @Override public Paint getInitialValue(RadialBarGauge radialBarGauge) {
                    return radialBarGauge.getSectionFill7();
                }
            };

        private static final CssMetaData<RadialBarGauge, Paint> SECTION_FILL_8 =
            new CssMetaData<RadialBarGauge, Paint>("-section-fill-8", PaintConverter.getInstance(), DEFAULT_SECTION_FILL_8) {

                @Override public boolean isSettable(RadialBarGauge radialBarGauge) {
                    return null == radialBarGauge.sectionFill8 || !radialBarGauge.sectionFill8.isBound();
                }

                @Override public StyleableProperty<Paint> getStyleableProperty(RadialBarGauge radialBarGauge) {
                    return (StyleableProperty) radialBarGauge.sectionFill8Property();
                }

                @Override public Paint getInitialValue(RadialBarGauge radialBarGauge) {
                    return radialBarGauge.getSectionFill8();
                }
            };

        private static final CssMetaData<RadialBarGauge, Paint> SECTION_FILL_9 =
            new CssMetaData<RadialBarGauge, Paint>("-section-fill-9", PaintConverter.getInstance(), DEFAULT_SECTION_FILL_9) {

                @Override public boolean isSettable(RadialBarGauge radialBarGauge) {
                    return null == radialBarGauge.sectionFill9 || !radialBarGauge.sectionFill9.isBound();
                }

                @Override public StyleableProperty<Paint> getStyleableProperty(RadialBarGauge radialBarGauge) {
                    return (StyleableProperty) radialBarGauge.sectionFill9Property();
                }

                @Override public Paint getInitialValue(RadialBarGauge radialBarGauge) {
                    return radialBarGauge.getSectionFill9();
                }
            };

        private static final CssMetaData<RadialBarGauge, Paint> MARKER_FILL_0 =
            new CssMetaData<RadialBarGauge, Paint>("-marker-fill-0", PaintConverter.getInstance(), DEFAULT_MARKER_FILL_0) {

                @Override public boolean isSettable(RadialBarGauge radialBarGauge) {
                    return null == radialBarGauge.markerFill0 || !radialBarGauge.markerFill0.isBound();
                }

                @Override public StyleableProperty<Paint> getStyleableProperty(RadialBarGauge radialBarGauge) {
                    return (StyleableProperty) radialBarGauge.markerFill0Property();
                }

                @Override public Paint getInitialValue(RadialBarGauge radialBarGauge) {
                    return radialBarGauge.getMarkerFill0();
                }
            };

        private static final CssMetaData<RadialBarGauge, Paint> MARKER_FILL_1 =
            new CssMetaData<RadialBarGauge, Paint>("-marker-fill-1", PaintConverter.getInstance(), DEFAULT_MARKER_FILL_1) {

                @Override public boolean isSettable(RadialBarGauge radialBarGauge) {
                    return null == radialBarGauge.markerFill1 || !radialBarGauge.markerFill1.isBound();
                }

                @Override public StyleableProperty<Paint> getStyleableProperty(RadialBarGauge radialBarGauge) {
                    return (StyleableProperty) radialBarGauge.markerFill1Property();
                }

                @Override public Paint getInitialValue(RadialBarGauge radialBarGauge) {
                    return radialBarGauge.getMarkerFill1();
                }
            };

        private static final CssMetaData<RadialBarGauge, Paint> MARKER_FILL_2 =
            new CssMetaData<RadialBarGauge, Paint>("-marker-fill-2", PaintConverter.getInstance(), DEFAULT_MARKER_FILL_2) {

                @Override public boolean isSettable(RadialBarGauge radialBarGauge) {
                    return null == radialBarGauge.markerFill2 || !radialBarGauge.markerFill2.isBound();
                }

                @Override public StyleableProperty<Paint> getStyleableProperty(RadialBarGauge radialBarGauge) {
                    return (StyleableProperty) radialBarGauge.markerFill2Property();
                }

                @Override public Paint getInitialValue(RadialBarGauge radialBarGauge) {
                    return radialBarGauge.getMarkerFill2();
                }
            };

        private static final CssMetaData<RadialBarGauge, Paint> MARKER_FILL_3 =
            new CssMetaData<RadialBarGauge, Paint>("-marker-fill-3", PaintConverter.getInstance(), DEFAULT_MARKER_FILL_3) {

                @Override public boolean isSettable(RadialBarGauge radialBarGauge) {
                    return null == radialBarGauge.markerFill3 || !radialBarGauge.markerFill3.isBound();
                }

                @Override public StyleableProperty<Paint> getStyleableProperty(RadialBarGauge radialBarGauge) {
                    return (StyleableProperty) radialBarGauge.markerFill3Property();
                }

                @Override public Paint getInitialValue(RadialBarGauge radialBarGauge) {
                    return radialBarGauge.getMarkerFill3();
                }
            };

        private static final CssMetaData<RadialBarGauge, Paint> MARKER_FILL_4 =
            new CssMetaData<RadialBarGauge, Paint>("-marker-fill-4", PaintConverter.getInstance(), DEFAULT_MARKER_FILL_4) {

                @Override public boolean isSettable(RadialBarGauge radialBarGauge) {
                    return null == radialBarGauge.markerFill4 || !radialBarGauge.markerFill4.isBound();
                }

                @Override public StyleableProperty<Paint> getStyleableProperty(RadialBarGauge radialBarGauge) {
                    return (StyleableProperty) radialBarGauge.markerFill4Property();
                }

                @Override public Paint getInitialValue(RadialBarGauge radialBarGauge) {
                    return radialBarGauge.getMarkerFill4();
                }
            };

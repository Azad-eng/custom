...
package com.ryl.customControls.gauge.radialBarGauge.skin;

import com.ryl.common.ConicalGradient;
import com.ryl.common.Marker;
import com.ryl.common.Section;
import com.ryl.common.ValueEvent;
import com.ryl.customControls.gauge.radialBarGauge.RadialBarGauge;
 ...
 * Time: 08:02
 */
public class RadialBarGaugeSkin extends SkinBase<RadialBarGauge> implements Skin<RadialBarGauge> {
    ...
    // ******************** Constructors **************************************
    public RadialBarGaugeSkin(RadialBarGauge radialBarGauge) {
        super(radialBarGauge);
        angleStep         = radialBarGauge.getAngleRange() / (radialBarGauge.getMaxValue() - radialBarGauge.getMinValue());

...
public class Demo extends Application {
    ...
    @Override public void init() {
        gauge = new GradientGauge(0, 0, 100, "Unit");
        counter       = 0;
    ...
    @Override public void start(Stage stage) {
        ...
        pane.setBackground(new Background(new BackgroundFill(Color.rgb(46, 46, 46), CornerRadii.EMPTY, Insets.EMPTY)));

        Scene scene = new Scene(pane);

        stage.setTitle("Gradient Gauge");

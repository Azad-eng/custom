package com.ryl.customControls.gauge.gradientGauge;
...
import com.ryl.customControls.gauge.library.medusa.GaugeBuilder;
import com.ryl.customControls.gauge.library.medusa.tools.ConicalGradient;
...
public class GradientGauge extends Region {
    ...
    private void handleControlPropertyChanged(final String PROPERTY) {
        if ("VALUE".equals(PROPERTY)) {
            if (model.isAnimated() && model.getAnimationDuration() < 2000) {
                model.setAnimationDuration(2000);
            }

...
package com.ryl.customControls.gauge.simpleGauge.skin;

import com.ryl.customControls.gauge.simpleGauge.SimpleGauge;
...
public class SimpleGaugeSkin extends SkinBase<SimpleGauge> implements Skin<SimpleGauge> {
    ...
    protected void handleControlPropertyChanged(final String PROPERTY) {
        if ("RESIZE".equals(PROPERTY)) {
            ...
            if (getSkinnable().isMeasuredRangeVisible()) {
                drawMeasuredRange();
            }

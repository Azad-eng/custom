...
public class PiButtonBuilder<B extends PiButtonBuilder<B>> {
    private HashMap<String, Property> properties = new HashMap<>();


    // ******************** Constructors **************************************
    protected PiButtonBuilder() {}


    // ******************** Methods *******************************************
    public static final PiButtonBuilder create() {
        return new PiButtonBuilder();
    }

    public final PiButtonBuilder selected(final boolean SELECTED) {
        properties.put("selected", new SimpleBooleanProperty(SELECTED));
        return this;
    }

    public final PiButtonBuilder text(final String TEXT) {
        properties.put("text", new SimpleStringProperty(TEXT));
        return this;
    }

    public final PiButtonBuilder ledColor(final Color LED_COLOR) {
    ...
    public final PiButton build() {
        final PiButton CONTROL = new PiButton();

...
package com.ryl.customControls.button.piButton.skin;

import com.ryl.common.Util;
import com.ryl.customControls.button.piButton.PiButton;
...
public class PiButtonSkin extends SkinBase<PiButton> implements Skin<PiButton> {
    ...
    // ******************** Constructors **************************************
    public PiButtonSkin(final PiButton CONTROL) {
        super(CONTROL);
        pane = new Pane();
        init();
        initGraphics();
    ...
    protected void handleControlPropertyChanged(final String PROPERTY) {
        if ("RESIZE".equals(PROPERTY)) {
            ...
            getSkinnable().fireSelectEvent(getSkinnable().isSelected() ? new PiButton.SelectEvent(getSkinnable(), getSkinnable(), PiButton.SelectEvent.SELECT) : new PiButton.SelectEvent(getSkinnable(), getSkinnable(), PiButton.SelectEvent.DESELECT));
            on.setVisible(getSkinnable().isSelected());
            ledOn.setVisible(getSkinnable().isSelected());

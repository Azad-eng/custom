...
package com.ryl.customControls.button.raspberryButton.skin;

import com.ryl.customControls.button.raspberryButton.RaspberryButton;
...
public class RaspberryButtonSkin extends SkinBase<RaspberryButton> implements Skin<RaspberryButton> {
    ...
    // ******************** Constructors **************************************
    public RaspberryButtonSkin(final RaspberryButton CONTROL) {
        super(CONTROL);

...
public class RaspberryButton extends Control {
    ...
    public String getUserAgentStylesheet() {
        return getClass().getResource("/button/raspberryButton/" + getClass().getSimpleName().toLowerCase() + ".css").toExternalForm();
    }

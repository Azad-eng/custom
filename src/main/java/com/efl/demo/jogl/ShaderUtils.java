...
public class ShaderUtils {
    static int createShaderProgram(GL3 gl, String vertexShaderFilePath, String fragmentShaderFilePath) {
        ...
        int vShaderObj = gl.glCreateShader(GL3.GL_VERTEX_SHADER);
        ...
        int fShaderObj = gl.glCreateShader(GL3.GL_FRAGMENT_SHADER);
